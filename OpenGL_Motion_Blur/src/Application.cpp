...
int main(void)
{
   ...
   /* const float data[6]{
    ...
    glm::mat4 model_translation = glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, 1.0f, 0.0f));
    glm::mat4 model_rotation = glm::rotate(glm::mat4(1.0f), glm::radians(45.0f), glm::vec3(0, 0, 1));
